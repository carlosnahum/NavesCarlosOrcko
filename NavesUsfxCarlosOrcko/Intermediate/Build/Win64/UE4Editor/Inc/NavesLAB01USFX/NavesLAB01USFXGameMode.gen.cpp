...
// Cross Module References
	NAVESLAB01USFX_API UEnum* Z_Construct_UEnum_NavesLAB01USFX_EEstadoFormacion();
...
// End Cross Module References
	static UEnum* EEstadoFormacion_StaticEnum()
	{
		static UEnum* Singleton = nullptr;
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_NavesLAB01USFX_EEstadoFormacion, Z_Construct_UPackage__Script_NavesLAB01USFX(), TEXT("EEstadoFormacion"));
		}
		return Singleton;
	}
	template<> NAVESLAB01USFX_API UEnum* StaticEnum<EEstadoFormacion>()
	{
		return EEstadoFormacion_StaticEnum();
	}
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EEstadoFormacion(EEstadoFormacion_StaticEnum, TEXT("/Script/NavesLAB01USFX"), TEXT("EEstadoFormacion"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_NavesLAB01USFX_EEstadoFormacion_Hash() { return 942809077U; }
	UEnum* Z_Construct_UEnum_NavesLAB01USFX_EEstadoFormacion()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_NavesLAB01USFX();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EEstadoFormacion"), 0, Get_Z_Construct_UEnum_NavesLAB01USFX_EEstadoFormacion_Hash(), false);
#else
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				{ "EEstadoFormacion::Libre", (int64)EEstadoFormacion::Libre },
				{ "EEstadoFormacion::FormandoInfinito", (int64)EEstadoFormacion::FormandoInfinito },
			};
#if WITH_METADATA
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				{ "BlueprintType", "true" },
				{ "Comment", "// Estados para la m?quina de estados del GameMode\n" },
				{ "FormandoInfinito.Name", "EEstadoFormacion::FormandoInfinito" },
				{ "Libre.Name", "EEstadoFormacion::Libre" },
				{ "ModuleRelativePath", "NavesLAB01USFXGameMode.h" },
				{ "ToolTip", "Estados para la m?quina de estados del GameMode" },
			};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ANavesLAB01USFXGameMode_Statics::NewProp_AEnemigos_MetaData[] = {
		{ "Comment", "// Contenedor de naves\n" },
		{ "ModuleRelativePath", "NavesLAB01USFXGameMode.h" },
		{ "ToolTip", "Contenedor de naves" },
	};
#endif
	...
	IMPLEMENT_CLASS(ANavesLAB01USFXGameMode, 288827537);
